...
public class ImageController {
    ...
    public String feed(User loginUser, Model model) {
    ...
    @PostMapping("/image")
    public String imageUpload(User loginUser, ImageDto imageReqDto) {
    ...
    public String imageExplore(User loginUser, Model model) {
    ...
    public String board(Model model, @PathVariable int imageid,User loginUser) {
    ...
    public ResponseEntity<?> boardDelete(Model model, @PathVariable int imageid, @PathVariable int ImageUserId, User loginUser) {
