...
public class FollowController {
    ...
    public ResponseEntity<List<FollowDto>> getFollowingList(@PathVariable int pageUserId,@Login LoginUserDto loginUser) {
    ...
    public ResponseEntity<List<FollowDto>> getFollowerList(@PathVariable int pageUserId,@Login LoginUserDto loginUser) {
    ...
    public @ResponseBody List<FollowDto> testFollowingList(@PathVariable int pageUserId, @Login LoginUserDto loginUser, Model model) {

        return followService.팔로잉리스트(loginUser.getId(), pageUserId);
    }

    @PostMapping("/follow/{id}")
    public ResponseEntity<?> follow(@PathVariable int id,@Login LoginUserDto loginUser) {
    ...
    public ResponseEntity<?> unFollow(@PathVariable int id,@Login LoginUserDto loginUser) {
